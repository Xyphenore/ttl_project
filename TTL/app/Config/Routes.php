 ...
 */
$routes->match(['get', 'post'], 'ads/createAds', 'AdsController::createAds');
$routes->match(['get', 'post'], 'ads/actionAds', 'AdsController::actionAds');
$routes->match(['get', 'post'], 'ads/updateAds', 'AdsController::updateAds');
