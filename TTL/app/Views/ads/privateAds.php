...
<div>
    <div style="border: thin solid black">
        <?php if (!empty($ads) && is_array($ads)) : ?>
            ...
            <!-- FIN SECTION ANNONCES PUBLIEES -->

            <!-- SECTION DES ANNONCES BROUILLONS -->
            <div>
            ...
            <!-- FIN SECTION ANNONCES BROUILLONS -->

            <!-- SECTION DES ANNONCES ARCHIVEES -->
            <div>
                <h3>Vos Annonces archivées</h3>
                <?php foreach ($ads as $ads_item) : ?>
            ...
            <!-- FIN SECTION ANNONCES ARCHIVEES -->

            <!-- SECTION DES ANNONCES BLOQUEES PAR UN ADMIN -->
            <div>
                <h3>Annonces bloquées</h3>
                <?php foreach ($ads as $ads_item) : ?>
