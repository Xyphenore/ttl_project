...
<section class='container border border-secondary my-auto rounded-3 p-4'>
    ...
    <div class="row px-4 py-2 g-3">
        <?php //Bloc Annonces ?>
        <div class="col-lg-4">
            <button class='border border-secondary w-100 h-100 rounded-3  p-3 bg-white' role='button'
                    form='dashboard-action' name='act' type='submit' value='Annonces'>
                <div class='pb-2'>
        ...
        <?php //Bloc Message ?>
        <div class="col-lg-4">
            <button class='border border-secondary rounded-3 w-100 h-100 p-3 bg-white' role='button'
                    form='dashboard-action' name='act' type='submit' value='Messages'>
                <div class='pb-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='60' height='60' fill='currentColor'
        ...
        <div class="col-lg-4">
            <button class='border border-secondary rounded-3 w-100 h-100 p-3 bg-white' role='button'
                    form='dashboard-action' name='act' type='submit' value='Paramètre'>
                <div class='pb-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' width='60' height='60' fill='currentColor'
                         class='bi bi-gear'
                         viewBox='0 0 16 16'>
